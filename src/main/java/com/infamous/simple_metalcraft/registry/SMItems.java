...
public class SMItems {
    ...
    public static final RegistryObject<Item> MITHRIL_ORE =
            ITEMS.register("mithril_ore",
                    () -> buildBuildingBlock(SMBlocks.MITHRIL_ORE.get()));

    public static final RegistryObject<Item> DEEPSLATE_MITHRIL_ORE =
            ITEMS.register("deepslate_mithril_ore",
                    () -> buildBuildingBlock(SMBlocks.DEEPSLATE_MITHRIL_ORE.get()));

    public static final RegistryObject<Item> RAW_MITHRIL =
            ITEMS.register("raw_mithril", SMItems::buildMaterial);

    public static final RegistryObject<Item> MITHRIL_NUGGET =
            ITEMS.register("mithril_nugget", SMItems::buildMaterial);

    public static final RegistryObject<Item> MITHRIL_SCRAP =
            ITEMS.register("mithril_scrap", SMItems::buildMaterial);

    public static final RegistryObject<Item> MITHRIL_INGOT =
            ITEMS.register("mithril_ingot", SMItems::buildMaterial);

    public static final RegistryObject<Item> MITHRIL_SWORD =
            ITEMS.register("mithril_sword", () -> buildSword(SMTiers.MITHRIL, 3, -2.4F));

    public static final RegistryObject<Item> MITHRIL_SHOVEL =
            ITEMS.register("mithril_shovel", () -> buildShovel(SMTiers.MITHRIL, 1.5F, -3.0F));

    public static final RegistryObject<Item> MITHRIL_PICKAXE =
            ITEMS.register("mithril_pickaxe", () -> buildPickaxe(SMTiers.MITHRIL, 1, -2.8F));

    public static final RegistryObject<Item> MITHRIL_AXE =
            ITEMS.register("mithril_axe", () -> buildAxe(SMTiers.MITHRIL, 6.0F, -3.0F));

    public static final RegistryObject<Item> MITHRIL_HOE =
            ITEMS.register("mithril_hoe", () -> buildHoe(SMTiers.MITHRIL, 0, -3.0F));

    public static final RegistryObject<Item> MITHRIL_HELMET =
            ITEMS.register("mithril_helmet", () -> buildHelmet(SMArmorMaterials.MITHRIL));

    public static final RegistryObject<Item> MITHRIL_CHESTPLATE =
            ITEMS.register("mithril_chestplate", () -> buildChestplate(SMArmorMaterials.MITHRIL));

    public static final RegistryObject<Item> MITHRIL_LEGGINGS =
            ITEMS.register("mithril_leggings", () -> buildLeggings(SMArmorMaterials.MITHRIL));

    public static final RegistryObject<Item> MITHRIL_BOOTS =
            ITEMS.register("mithril_boots", () -> buildBoots(SMArmorMaterials.MITHRIL));

    // ADAMANTINE
    public static final RegistryObject<Item> ADAMANTINE_ORE =
            ITEMS.register("adamantine_ore",
                    () -> buildBuildingBlock(SMBlocks.ADAMANTINE_ORE.get()));

    public static final RegistryObject<Item> DEEPSLATE_ADAMANTINE_ORE =
            ITEMS.register("deepslate_adamantine_ore",
                    () -> buildBuildingBlock(SMBlocks.DEEPSLATE_ADAMANTINE_ORE.get()));

    public static final RegistryObject<Item> RAW_ADAMANTINE =
            ITEMS.register("raw_adamantine", SMItems::buildMaterial);

    public static final RegistryObject<Item> ADAMANTINE_NUGGET =
            ITEMS.register("adamantine_nugget", SMItems::buildMaterial);

    public static final RegistryObject<Item> ADAMANTINE_SCRAP =
            ITEMS.register("adamantine_scrap", SMItems::buildMaterial);

    public static final RegistryObject<Item> ADAMANTINE_INGOT =
            ITEMS.register("adamantine_ingot", SMItems::buildMaterial);

    public static final RegistryObject<Item> ADAMANTINE_SWORD =
            ITEMS.register("adamantine_sword", () -> buildSword(SMTiers.ADAMANTINE, 3, -2.4F));

    public static final RegistryObject<Item> ADAMANTINE_SHOVEL =
            ITEMS.register("adamantine_shovel", () -> buildShovel(SMTiers.ADAMANTINE, 1.5F, -3.0F));

    public static final RegistryObject<Item> ADAMANTINE_PICKAXE =
            ITEMS.register("adamantine_pickaxe", () -> buildPickaxe(SMTiers.ADAMANTINE, 1, -2.8F));

    public static final RegistryObject<Item> ADAMANTINE_AXE =
            ITEMS.register("adamantine_axe", () -> buildAxe(SMTiers.ADAMANTINE, 6.0F, -3.0F));

    public static final RegistryObject<Item> ADAMANTINE_HOE =
            ITEMS.register("adamantine_hoe", () -> buildHoe(SMTiers.ADAMANTINE, 0, -3.0F));

    public static final RegistryObject<Item> ADAMANTINE_HELMET =
            ITEMS.register("adamantine_helmet", () -> buildHelmet(SMArmorMaterials.ADAMANTINE));

    public static final RegistryObject<Item> ADAMANTINE_CHESTPLATE =
            ITEMS.register("adamantine_chestplate", () -> buildChestplate(SMArmorMaterials.ADAMANTINE));

    public static final RegistryObject<Item> ADAMANTINE_LEGGINGS =
            ITEMS.register("adamantine_leggings", () -> buildLeggings(SMArmorMaterials.ADAMANTINE));

    public static final RegistryObject<Item> ADAMANTINE_BOOTS =
            ITEMS.register("adamantine_boots", () -> buildBoots(SMArmorMaterials.ADAMANTINE));
