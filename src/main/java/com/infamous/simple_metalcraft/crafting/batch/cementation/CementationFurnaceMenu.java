...
public class CementationFurnaceMenu extends AbstractFurnaceMenu {
    ...
    public CementationFurnaceMenu(int containerId, Inventory inventory) {
        super(SMMenuTypes.CEMENTATION_FURNACE.get(), SMRecipes.Types.CEMENTATION, RecipeBookType.FURNACE, containerId, inventory);
    }

    public CementationFurnaceMenu(int containerId, Inventory inventory, Container container, ContainerData containerData) {
        super(SMMenuTypes.CEMENTATION_FURNACE.get(), SMRecipes.Types.CEMENTATION, RecipeBookType.FURNACE, containerId, inventory, container, containerData);
    }
